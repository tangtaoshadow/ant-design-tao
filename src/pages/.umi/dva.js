...
app.model({ namespace: 'irt_standard_library_update', ...(require('F:/java/antd-2/ant-design-tao/src/models/irt_standard_library_update.js').default) });
...
app.model({ namespace: 'public_irt_standard_library_detail', ...(require('F:/java/antd-2/ant-design-tao/src/models/public_irt_standard_library_detail.js').default) });
app.model({ namespace: 'public_irt_standard_library_list', ...(require('F:/java/antd-2/ant-design-tao/src/models/public_irt_standard_library_list.js').default) });
app.model({ namespace: 'public_irt_standard_library_update', ...(require('F:/java/antd-2/ant-design-tao/src/models/public_irt_standard_library_update.js').default) });
...
app.model({ namespace: 'public_standard_library_list', ...(require('F:/java/antd-2/ant-design-tao/src/models/public_standard_library_list.js').default) });
app.model({ namespace: 'public_standard_library_update', ...(require('F:/java/antd-2/ant-design-tao/src/models/public_standard_library_update.js').default) });
